...
+ Python 函式庫
  ...
  + ply
  + Xie
    用於動態組字。可到 https://github.com/xrloong/Xie 下載最新版本（https://github.com/xrloong/Xie/releases/download/v0.1.1/Xie-0.1.1-py2.py3-none-any.whl）
+ 工具
  + xsltproc
  + xmllint
...
$ pip3 install https://github.com/xrloong/Xie/releases/download/v0.1.1/Xie-0.1.1-py2.py3-none-any.whl
```
