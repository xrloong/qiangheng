...
class GXBrickTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.brickStroke0 = GXBrick.instanceForStroke(
            GXCorner.TopLeft, GXStroke.Stroke0
        )
        self.brickStroke1 = GXBrick.instanceForStroke(
            GXCorner.TopLeft, GXStroke.Stroke1
        )
        self.brickStroke2 = GXBrick.instanceForStroke(
            GXCorner.TopLeft, GXStroke.Stroke2
        )
        self.brickStroke3 = GXBrick.instanceForStroke(
            GXCorner.TopLeft, GXStroke.Stroke3
        )
        self.brickStroke4 = GXBrick.instanceForStroke(
            GXCorner.TopLeft, GXStroke.Stroke4
        )
        self.brickStroke5 = GXBrick.instanceForStroke(
            GXCorner.TopLeft, GXStroke.Stroke5
        )
        self.brickStroke6 = GXBrick.instanceForStroke(
            GXCorner.TopLeft, GXStroke.Stroke6
        )
        self.brickStroke7 = GXBrick.instanceForStroke(
            GXCorner.TopLeft, GXStroke.Stroke7
        )
        self.brickStroke8 = GXBrick.instanceForStroke(
            GXCorner.TopLeft, GXStroke.Stroke8
        )
        self.brickStroke9 = GXBrick.instanceForStroke(
            GXCorner.TopLeft, GXStroke.Stroke9
        )

        self.brickInvalidate = GXBrick.instanceForInvalidate()
        self.brickReference = GXBrick.instanceForReference(
            GXCorner.TopLeft, self.brickStroke
        )
    ...
    def test_getStroke(self):
        ...
        brickReference3 = GXBrick.instanceForReference(
            GXCorner.TopLeft, self.brickStroke3
        )
        self.assertEqual(brickReference3.getStroke(), GXStroke.Stroke3)

        brickReference8 = GXBrick.instanceForReference(
            GXCorner.TopLeft, self.brickStroke8
        )
        self.assertEqual(brickReference8.getStroke(), GXStroke.Stroke8)

        brickReferenceInvalidate = GXBrick.instanceForReference(
            GXCorner.TopLeft, self.brickInvalidate
        )
        self.assertEqual(brickReferenceInvalidate.getStroke(), GXStroke.StrokeNone)

        brickReferenceOfReference8 = GXBrick.instanceForReference(
            GXCorner.TopLeft, brickReference8
        )
