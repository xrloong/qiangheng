...
class GXUtilTestCase(unittest.TestCase):
    ...
    def test_constructCorners(self):
        ...
        self.assertEqual(
            corners,
            (GXStroke.Stroke2, GXStroke.Stroke0, GXStroke.Stroke3, GXStroke.Stroke7),
        )

        corners = util.constructCorners("2a3c")
        self.assertEqual(
            corners,
            (GXStroke.Stroke2, GXCorner.TopLeft, GXStroke.Stroke3, GXCorner.BottomLeft),
        )

        corners = util.constructCorners("59b4")
        self.assertEqual(
            corners,
            (GXStroke.Stroke5, GXStroke.Stroke9, GXCorner.TopRight, GXStroke.Stroke4),
        )
