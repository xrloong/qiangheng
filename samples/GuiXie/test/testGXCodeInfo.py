...
class GXCodeInfoTestCase(unittest.TestCase):
	...
	def test_computeStrokes_Zhong(self):
		...
		self.assertEqual(computeStrokes(GXGenre.Zhong, [gxLump1]), [GXStroke.Stroke1, GXStroke.Stroke8, GXStroke.Stroke5, GXStroke.Stroke9])

		# 舟（1/28330）
		gxLump1 = GXLump(util.constructCorners("2833"))
		self.assertEqual(computeStrokes(GXGenre.Zhong, [gxLump1]), [GXStroke.Stroke2, GXStroke.Stroke8, GXStroke.Stroke3, GXStroke.Stroke3])

		# 中（1/58082）
		gxLump1 = GXLump(util.constructCorners("58a8"), 2)
		self.assertEqual(computeStrokes(GXGenre.Zhong, [gxLump1]), [GXStroke.Stroke5, GXStroke.Stroke8, GXStroke.StrokeNone, GXStroke.Stroke8])
	...
	def test_computeStrokes_Guo(self):
		...
		self.assertEqual(computeStrokes(GXGenre.Guo, [gxLump1, gxLump2]), [GXStroke.Stroke8, GXStroke.Stroke1, GXStroke.Stroke3, GXStroke.Stroke8])

		# 延（2/14270）
		gxLump1 = GXLump(util.constructCorners("1844"))
		gxLump2 = GXLump(util.constructCorners("2077"))
		self.assertEqual(computeStrokes(GXGenre.Guo, [gxLump1, gxLump2]), [GXStroke.Stroke1, GXStroke.Stroke4, GXStroke.Stroke2, GXStroke.Stroke7])
	...
	def test_computeStrokes_Zi(self):
		...
		self.assertEqual(computeStrokes(GXGenre.Zi, [gxLump1, gxLump2]), [GXStroke.Stroke3, GXStroke.Stroke3, GXStroke.Stroke9, GXStroke.Stroke2])

		# 腎（3/84825）
		gxLump1 = GXLump(util.constructCorners("8884"))
		gxLump2 = GXLump(util.constructCorners("8822"))
		self.assertEqual(computeStrokes(GXGenre.Zi, [gxLump1, gxLump2]), [GXStroke.Stroke8, GXStroke.Stroke4, GXStroke.Stroke8, GXStroke.Stroke2])
	...
	def test_computeStrokes_Gui(self):
		...
		self.assertEqual(computeStrokes(GXGenre.Gui, [gxLump1, gxLump2]), [GXStroke.Stroke1, GXStroke.Stroke2, GXStroke.Stroke8, GXStroke.Stroke3])

		# 名（4/82881）
		gxLump1 = GXLump(util.constructCorners("2820"))
		gxLump2 = GXLump(util.constructCorners("8888"))
		self.assertEqual(computeStrokes(GXGenre.Gui, [gxLump1, gxLump2]), [GXStroke.Stroke8, GXStroke.Stroke2, GXStroke.Stroke8, GXStroke.Stroke8])

		# 多（4/82220）
		gxLump1 = GXLump(util.constructCorners("282c"))
		gxLump2 = GXLump(util.constructCorners("282c"))
		self.assertEqual(computeStrokes(GXGenre.Gui, [gxLump1, gxLump2]), [GXStroke.Stroke8, GXStroke.Stroke2, GXStroke.Stroke2, GXStroke.Stroke2])
	...
	def test_computeStrokes_Xie(self):
		...
		self.assertEqual(computeStrokes(GXGenre.Xie, [gxLump1, gxLump2]), [GXStroke.Stroke3, GXStroke.Stroke9, GXStroke.Stroke2, GXStroke.Stroke9])

		# 務（5/12920）    5/12920
		gxLump1 = GXLump(util.constructCorners("1072"))
		gxLump2 = GXLump(util.constructCorners("9032"))
		self.assertEqual(computeStrokes(GXGenre.Xie, [gxLump1, gxLump2]), [GXStroke.Stroke1, GXStroke.Stroke2, GXStroke.Stroke9, GXStroke.Stroke2])
