...
class FCLump:
    ...
    def computeCodesOfExceptTopLeft(self):
        return self.computeCodes(
            (FCCorner.TopRight, FCCorner.BottomLeft, FCCorner.BottomRight)
        )

    def computeCodesOfExceptTopRight(self):
        return self.computeCodes(
            (FCCorner.TopLeft, FCCorner.BottomLeft, FCCorner.BottomRight)
        )

    def computeCodesOfExceptBottomLeft(self):
        return self.computeCodes(
            (FCCorner.TopLeft, FCCorner.TopRight, FCCorner.BottomRight)
        )

    def computeCodesOfExceptBottomRight(self):
        return self.computeCodes(
            (FCCorner.TopLeft, FCCorner.TopRight, FCCorner.BottomLeft)
        )
